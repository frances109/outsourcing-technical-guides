...
$site_key = function_exists( 'otg_get_setting' )
    ? otg_get_setting( 'otg_recaptcha_site_key' )
    : get_option( 'otg_recaptcha_site_key', '' );
...
if ( $hub_mode ) :
    ...
    wp_enqueue_style( 'otg-iti-css',       'https://cdn.jsdelivr.net/npm/intl-tel-input@21.1.4/build/css/intlTelInput.css',     [], null );
endif;
